...
router.get("/traders", (req, res) => {
  const traders = store.getTraders().map((trader) => ({
    ...
    longActive: trader.longActive,
    shortActive: trader.shortActive,
    longEntry: trader.longEntry,
    shortEntry: trader.shortEntry,
    longTp: trader.longTp,
    shortTp: trader.shortTp,
    longSl: trader.longSl,
    shortSl: trader.shortSl,
