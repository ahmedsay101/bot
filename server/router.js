...
router.get("/traders", (req, res) => {
  const traders = store.getTraders().map((trader) => ({
    ...
    ladderLevels: trader.ladderLevels,
    ladderGapPercent: trader.ladderGapPercent,
    takeProfitPercent: trader.takeProfitPercent,
    stopLossPercent: trader.stopLossPercent,
    longs: trader.longs || [],
    shorts: trader.shorts || [],
    accumulatedTpCount: trader.accumulatedTpCount,
    accumulatedSlCount: trader.accumulatedSlCount,
    accumulatedTpPnl: trader.accumulatedTpPnl,
    accumulatedSlPnl: trader.accumulatedSlPnl,
