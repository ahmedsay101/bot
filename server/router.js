...
router.get("/traders", (req, res) => {
  const traders = store.getTraders().map((trader) => ({
    ...
    numOrders: trader.numOrders,
    distancePercent: trader.distancePercent,
    notionalPerOrder: trader.notionalPerOrder,
    takeProfitPercent: trader.takeProfitPercent,
    orders: trader.orders || [],
    averagePrice: trader.averagePrice,
    tpPrice: trader.tpPrice,
    filledCount: trader.filledCount,
    totalFilledQty: trader.totalFilledQty,
