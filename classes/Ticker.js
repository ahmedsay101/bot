...
class Ticker {
  ...
  async tick() {
    try {
      ...
      //if(this.currentPrice > 85500) this.side = "SHORT";
      //if(this.currentPrice < 84500) this.side = "LONG";
      //this.currentPrice = this.side === "LONG" ? this.currentPrice += 50 : this.currentPrice -= 50;
